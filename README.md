...
Votre défi consiste à créer ce formulaire en plusieurs étapes et à le rendre aussi proche que possible de la conception.
...
Terminez chaque étape de la séquence
...
Recevez des messages de validation de formulaire si :
Un champ a été manqué
...
```
cd existing_repo
git remote add origin https://gitlab.com/js-taches-validation/multi-step-form.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/js-taches-validation/multi-step-form/-/settings/integrations)
